    ...
    return (
      <div className={'help-dialog ' + status}>
        <div className={'content'}>
          ...
          <p>
            You can only use each letter once. Words you have written will appear below the answer
            input area. You can click on these words to remove them and return their letters to be
            reused.
          </p>
          <p>
